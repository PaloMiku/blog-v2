    ...
    <header class="link-reminder">
        <div class="content">
            ...
            <p>
                ...
                <ProseA href="/palomiku.opml">友链源 OPML 聚合</ProseA>，可导入阅读器或
                <!-- eslint-disable-next-line vue/singleline-html-element-content-newline -->
                <ProseA href="https://app.follow.is">订阅 Follow List</ProseA>。
            </p>
        </div>
        <div class="operations">
            ...
            <ProseA href="https://app.follow.is" icon="ph:list-plus-bold">
                在 Follow 上订阅
            </ProseA>
        </div>
    </header>
