...
const blogConfig = {
    ...
    favicon: 'https://cravatar.cn/avatar/1012bf78fb01d5b964c3a9a0f515911a.png',
    language: 'zh',
    qqGroup: '767876073',
    ...
    // 用于 Twikoo 评论系统
    twikoo: {
        js: 'https://s4.zstatic.net/ajax/libs/twikoo/1.6.41/twikoo.all.min.js',
        // 自己部署的 Twikoo 服务
...
export const routeRules = <NitroConfig['routeRules']>{
    ...
    '/palomiku.opml': { prerender: true, headers: { 'Content-Type': 'application/xml' } },
}
